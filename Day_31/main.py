...
def reset_timer():
    ...
    canvas.itemconfig(a, text="00:00", fill="white", font=(FONT_NAME, 35, "bold"))
...
def count_down(count):
    ...
    canvas.itemconfig(a, text=f"{count_min}:{count_sec}")
    if count > 0:
        print(count)
...
canvas = Canvas(width=200, height=224, bg="#222222", highlightthickness=0)
